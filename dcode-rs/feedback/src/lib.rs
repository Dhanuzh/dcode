...
#[derive(Clone)]
pub struct DcodeFeedback {
    inner: Arc<FeedbackInner>,
}

impl Default for DcodeFeedback {
    fn default() -> Self {
        Self::new()
    }
}
...
impl FeedbackSnapshot {
    ...
    pub fn save_to_temp_file(&self) -> io::Result<PathBuf> {
        ...
        let filename = format!("dcode-feedback-{}.log", self.thread_id);
    ...
    fn feedback_attachments(
        ...
        if include_logs {
            attachments.push(Attachment {
                ...
                filename: String::from("dcode-logs.log"),
...
mod tests {
    ...
    fn ring_buffer_drops_front_when_full() {
        let fb = DcodeFeedback::with_capacity(8);
        {
    ...
    fn feedback_attachments_gate_connectivity_diagnostics() {
        ...
        let attachments_without_diagnostics = DcodeFeedback::new()
            .snapshot(None)
