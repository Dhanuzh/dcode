...
//!
//! This crate wraps [`dcode_app_server::in_process`] behind a single async API
...
//! [`InProcessClientHandle`](dcode_app_server::in_process::InProcessClientHandle),
...
pub use dcode_app_server::in_process::DEFAULT_IN_PROCESS_CHANNEL_CAPACITY;
pub use dcode_app_server::in_process::InProcessServerEvent;
use dcode_app_server::in_process::InProcessStartArgs;
...
use dcode_app_server_protocol::Result as JsonRpcResult;
...
fn event_requires_delivery(event: &InProcessServerEvent) -> bool {
    ...
    match event {
        InProcessServerEvent::ServerNotification(
            dcode_app_server_protocol::ServerNotification::TurnCompleted(_),
        ) => true,
        InProcessServerEvent::LegacyNotification(notification) => matches!(
            notification
                .method
                .strip_prefix("dcode/event/")
...
pub struct InProcessClientStartArgs {
    ...
    pub feedback: DcodeFeedback,
    /// Startup warnings emitted after initialize succeeds.
    pub config_warnings: Vec<ConfigWarningNotification>,
    /// Session source recorded in app-server thread metadata.
    pub session_source: SessionSource,
    /// Whether auth loading should honor the `DCODE_API_KEY` environment variable.
    pub enable_dcode_api_key_env: bool,
...
impl InProcessClientStartArgs {
    ...
    fn into_runtime_start_args(self, shared_core: &SharedCoreManagers) -> InProcessStartArgs {
        ...
        InProcessStartArgs {
            ...
            enable_dcode_api_key_env: self.enable_dcode_api_key_env,
            initialize,
...
/// - [`dcode_app_server::in_process::InProcessClientHandle`], which speaks to
...
impl InProcessAppServerClient {
    ...
    pub async fn start(args: InProcessClientStartArgs) -> IoResult<Self> {
        ...
        let mut handle =
            dcode_app_server::in_process::start(args.into_runtime_start_args(&shared_core)).await?;
...
mod tests {
    ...
    use dcode_app_server_protocol::ConfigRequirementsReadResponse;
    ...
    use dcode_app_server_protocol::ServerNotification;
    use dcode_app_server_protocol::SessionSource as ApiSessionSource;
    ...
    async fn start_test_client_with_capacity(
        ...
        InProcessAppServerClient::start(InProcessClientStartArgs {
            ...
            client_name: "dcode-app-server-client-test".to_string(),
    ...
    async fn typed_request_reports_json_rpc_errors() {
        ...
        let err = client
            .request_typed::<ConfigRequirementsReadResponse>(ClientRequest::ThreadRead {
                ...
                params: dcode_app_server_protocol::ThreadReadParams {
    ...
    async fn shared_thread_manager_tracks_threads_started_via_app_server() {
        ...
        let response: ThreadStartResponse = client
            ...
            .await
            .expect("thread/start should succeed");
        let created_thread_id = dcode_protocol::ThreadId::from_string(&response.thread.id)
    ...
    async fn remote_typed_request_roundtrip_works() {
        ...
        let response: GetAccountResponse = client
            .request_typed(ClientRequest::GetAccount {
                request_id: RequestId::Integer(1),
                params: dcode_app_server_protocol::GetAccountParams {
                    refresh_token: false,
                },
            })
            .await
    ...
    fn event_requires_delivery_marks_terminal_events() {
        assert!(event_requires_delivery(
            &InProcessServerEvent::ServerNotification(
                dcode_app_server_protocol::ServerNotification::TurnCompleted(
                    dcode_app_server_protocol::TurnCompletedNotification {
                        thread_id: "thread".to_string(),
                        turn: dcode_app_server_protocol::Turn {
                            id: "turn".to_string(),
                            items: Vec::new(),
                            status: dcode_app_server_protocol::TurnStatus::Completed,
                            error: None,
                        },
                    }
                )
        ...
        assert!(event_requires_delivery(
            &InProcessServerEvent::LegacyNotification(
                dcode_app_server_protocol::JSONRPCNotification {
                    method: "dcode/event/turn_aborted".to_string(),
                    params: None,
                }
            )
        ));
