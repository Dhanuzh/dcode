...
#[command(name = "dcode-network-proxy", about = "Dcode network sandbox proxy")]
pub struct Args {}
...
impl NetworkProxyBuilder {
    ...
    pub fn managed_by_dcode(mut self, managed_by_dcode: bool) -> Self {
        self.managed_by_dcode = managed_by_dcode;
        self
    }
...
mod tests {
    ...
    #[tokio::test]
    async fn non_dcode_managed_proxy_builder_uses_configured_ports() {
