use clap::Parser;
use clap::ValueHint;
use dcode_utils_cli::ApprovalModeCliArg;
...
pub struct Cli {
    ...
    // These are not exposed as user flags on the base `dcode` command.
    #[clap(skip)]
    ...
    pub sandbox_mode: Option<dcode_utils_cli::SandboxModeCliArg>,
