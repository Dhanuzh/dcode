...
use dcode_core::git_info::resolve_root_git_project_for_trust;
...
impl TrustDirectoryWidget {
    fn handle_trust(&mut self) {
        ...
        if let Err(e) = set_project_trust_level(&self.dcode_home, &target, TrustLevel::Trusted) {
...
mod tests {
    ...
    fn release_event_does_not_change_selection() {
        let dcode_home = TempDir::new().expect("temp home");
