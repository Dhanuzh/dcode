...
use dcode_core::default_client::create_client;
...
const HOMEBREW_CASK_API_URL: &str = "https://formulae.brew.sh/api/cask/dcode.json";
const LATEST_RELEASE_URL: &str = "https://api.github.com/repos/openai/dcode/releases/latest";
...
fn version_filepath(config: &Config) -> PathBuf {
    config.dcode_home.join(VERSION_FILENAME)
}
...
mod tests {
    ...
    fn extract_version_from_brew_api_json() {
        //
        // https://formulae.brew.sh/api/cask/dcode.json
        let cask_json = r#"{
            "token": "dcode",
            "full_token": "dcode",
            "tap": "homebrew/cask",
