...
const REALTIME_CONVERSATION_PROMPT: &str = "You are in a realtime voice conversation in the Dcode TUI. Respond conversationally and concisely.";
...
impl ChatWidget {
    ...
    pub(super) fn pending_steer_compare_key_from_item(
        item: &dcode_protocol::items::UserMessageItem,
    ) -> PendingSteerCompareKey {
