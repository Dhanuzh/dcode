...
fn into_app_server_cli(cli: Cli) -> dcode_tui_app_server::Cli {
...
fn into_legacy_exit_info(exit_info: dcode_tui_app_server::AppExitInfo) -> AppExitInfo {
    AppExitInfo {
...
fn main() -> anyhow::Result<()> {
    arg0_dispatch_or_else(|arg0_paths: Arg0DispatchPaths| async move {
        ...
        let use_app_server_tui = dcode_tui::should_use_app_server_tui(&inner).await?;
