...
pub(crate) async fn maybe_emit_implicit_skill_invocation(
    ...
    let skill_scope = match invocation.skill_scope {
        dcode_protocol::protocol::SkillScope::User => "user",
        dcode_protocol::protocol::SkillScope::Repo => "repo",
        dcode_protocol::protocol::SkillScope::System => "system",
        dcode_protocol::protocol::SkillScope::Admin => "admin",
    };
