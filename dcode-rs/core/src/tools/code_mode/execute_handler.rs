...
impl CodeModeExecuteHandler {
    async fn execute(
        &self,
        session: std::sync::Arc<crate::dcode::Session>,
        turn: std::sync::Arc<crate::dcode::TurnContext>,
        call_id: String,
        code: String,
    ) -> Result<FunctionToolOutput, FunctionCallError> {
        let args =
            dcode_code_mode::parse_exec_source(&code).map_err(FunctionCallError::RespondToModel)?;
        ...
        let response = exec
            ...
            .services
            .code_mode_service
            .execute(dcode_code_mode::ExecuteRequest {
