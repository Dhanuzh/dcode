...
use dcode_otel::ToolDecisionSource;
...
impl ToolOrchestrator {
    ...
    pub async fn run<Rq, Out, T>(
        ...
        req: &Rq,
        tool_ctx: &ToolCtx,
        turn_ctx: &crate::dcode::TurnContext,
        ...
        T: ToolRuntime<Rq, Out>,
    {
        ...
        let initial_attempt = SandboxAttempt {
            ...
            dcode_linux_sandbox_exe: turn_ctx.dcode_linux_sandbox_exe.as_ref(),
            use_legacy_landlock,
        ...
        match first_result {
            ...
            Err(ToolError::Dcode(DcodeErr::Sandbox(SandboxErr::Denied {
                output,
