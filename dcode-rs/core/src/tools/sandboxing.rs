...
pub(crate) enum ExecApprovalRequirement {
    ...
    Skip {
        ...
        /// Only applies if the command fails to run in sandbox and dcode prompts the user to run outside the sandbox.
...
pub(crate) struct SandboxAttempt<'a> {
    ...
    pub dcode_linux_sandbox_exe: Option<&'a std::path::PathBuf>,
    ...
    pub fn env_for(
        ...
        self.manager
            .transform(crate::sandboxing::SandboxTransformRequest {
                ...
                dcode_linux_sandbox_exe: self.dcode_linux_sandbox_exe,
