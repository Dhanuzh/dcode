...
use core_test_support::dcode_linux_sandbox_exe_or_skip;
...
async fn guardian_allows_shell_additional_permissions_requests_past_policy_validation() {
    ...
    turn_context_raw.dcode_linux_sandbox_exe = dcode_linux_sandbox_exe_or_skip!();
    turn_context_raw
        .approval_policy
...
async fn guardian_subagent_does_not_inherit_parent_exec_policy_rules() {
    let dcode_home = tempdir().expect("create dcode home");
    ...
    config.config_layer_stack = ConfigLayerStack::new(
        vec![ConfigLayerEntry::new(
            ConfigLayerSource::Project {
                dot_dcode_folder: AbsolutePathBuf::from_absolute_path(project_dir.path())
