...
const CURRENT_THREAD_SECTION_TOKEN_BUDGET: usize = 800;
const RECENT_WORK_SECTION_TOKEN_BUDGET: usize = 1_400;
const WORKSPACE_SECTION_TOKEN_BUDGET: usize = 1_000;
const NOTES_SECTION_TOKEN_BUDGET: usize = 200;
const MAX_CURRENT_THREAD_TURNS: usize = 1;
const MAX_RECENT_THREADS: usize = 20;
const MAX_RECENT_WORK_GROUPS: usize = 5;
const MAX_CURRENT_CWD_ASKS: usize = 5;
const MAX_OTHER_CWD_ASKS: usize = 3;
const MAX_ASK_CHARS: usize = 160;
