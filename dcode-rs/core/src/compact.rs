...
use crate::dcode::get_last_assistant_message_from_turn;
...
const COMPACT_USER_MESSAGE_MAX_TOKENS: usize = 10_000;
...
async fn run_compact_task_inner(
    ...
    loop {
        ...
        match attempt_result {
            ...
            Err(DcodeErr::Interrupted) => {
                return Err(DcodeErr::Interrupted);
            }
            Err(e @ DcodeErr::ContextWindowExceeded) => {
                if turn_input_len > 1 {
