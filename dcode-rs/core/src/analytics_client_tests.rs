...
use super::DcodeAppMentionedEventRequest;
use super::DcodeAppUsedEventRequest;
use super::DcodePluginEventRequest;
use super::DcodePluginUsedEventRequest;
use super::InvocationType;
use super::TrackEventRequest;
use super::TrackEventsContext;
use super::dcode_app_metadata;
use super::dcode_plugin_metadata;
use super::dcode_plugin_used_metadata;
...
fn normalize_path_for_skill_id_repo_scoped_uses_relative_path() {
    ...
    let skill_path = PathBuf::from("/repo/root/.dcode/skills/doc/SKILL.md");
    ...
    assert_eq!(path, ".dcode/skills/doc/SKILL.md");
}

#[test]
fn normalize_path_for_skill_id_user_scoped_uses_absolute_path() {
    let skill_path = PathBuf::from("/Users/abc/.dcode/skills/doc/SKILL.md");
...
fn normalize_path_for_skill_id_admin_scoped_uses_absolute_path() {
    let skill_path = PathBuf::from("/etc/dcode/skills/doc/SKILL.md");
...
fn normalize_path_for_skill_id_repo_root_not_in_skill_path_uses_absolute_path() {
    let repo_root = PathBuf::from("/repo/root");
    let skill_path = PathBuf::from("/other/path/.dcode/skills/doc/SKILL.md");
...
fn app_mentioned_event_serializes_expected_shape() {
    ...
    let event = TrackEventRequest::AppMentioned(DcodeAppMentionedEventRequest {
        event_type: "dcode_app_mentioned",
        event_params: dcode_app_metadata(
            &tracking,
            AppInvocation {
...
fn app_used_event_serializes_expected_shape() {
    ...
    let event = TrackEventRequest::AppUsed(DcodeAppUsedEventRequest {
...
fn plugin_used_event_serializes_expected_shape() {
    ...
    let event = TrackEventRequest::PluginUsed(DcodePluginUsedEventRequest {
        event_type: "dcode_plugin_used",
        event_params: dcode_plugin_used_metadata(&tracking, sample_plugin_metadata()),
    });
...
fn plugin_management_event_serializes_expected_shape() {
    let event = TrackEventRequest::PluginInstalled(DcodePluginEventRequest {
        event_type: "dcode_plugin_installed",
        event_params: dcode_plugin_metadata(sample_plugin_metadata()),
    });
