  ...
  "plugins": [
    ...
    assert_eq!(
        ...
        ResolvedMarketplacePlugin {
            plugin_id: PluginId::new("local-plugin".to_string(), "dcode-curated".to_string())
                .unwrap(),
...
fn resolve_marketplace_plugin_reports_missing_plugin() {
    ...
    assert_eq!(
        err.to_string(),
        "plugin `missing` was not found in marketplace `dcode-curated`"
    );
}
...
fn list_marketplaces_resolves_plugin_interface_paths_to_absolute() {
  ...
  "interface": {
    ...
    assert_eq!(
        ...
        Some(vec![Product::Dcode, Product::Chatgpt, Product::Atlas])
    );
    assert_eq!(
...
fn resolve_marketplace_plugin_rejects_disallowed_product() {
  ...
  "plugins": [
    ...
    assert_eq!(
        err.to_string(),
        "plugin `chatgpt-plugin` is not available for install in marketplace `dcode-curated`"
    );
}
...
fn resolve_marketplace_plugin_allows_missing_products_field() {
  ...
  "plugins": [
    ...
    assert_eq!(resolved.plugin_id.as_key(), "default-plugin@dcode-curated");
}
...
fn resolve_marketplace_plugin_rejects_explicit_empty_products() {
  ...
  "plugins": [
    ...
    assert_eq!(
        err.to_string(),
        "plugin `disabled-plugin` is not available for install in marketplace `dcode-curated`"
    );
}
