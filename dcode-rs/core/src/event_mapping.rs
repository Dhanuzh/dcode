...
use dcode_protocol::models::is_image_close_tag_text;
use dcode_protocol::models::is_image_open_tag_text;
use dcode_protocol::models::is_local_image_close_tag_text;
use dcode_protocol::models::is_local_image_open_tag_text;
...
pub fn parse_turn_item(item: &ResponseItem) -> Option<TurnItem> {
    match item {
        ...
        ResponseItem::ImageGenerationCall {
            ...
            dcode_protocol::items::ImageGenerationItem {
                id: id.clone(),
                status: status.clone(),
