...
use crate::dcode::PreviousTurnSettings;
use crate::dcode::SessionConfiguration;
...
pub(crate) struct SessionState {
    ...
    pub(crate) pending_session_start_source: Option<dcode_hooks::SessionStartSource>,
...
impl SessionState {
    ...
    pub(crate) fn set_pending_session_start_source(
        &mut self,
        value: Option<dcode_hooks::SessionStartSource>,
    ) {
...
// missing values as the default `"dcode"` bucket.
fn merge_rate_limit_fields(
    previous: Option<&RateLimitSnapshot>,
    mut snapshot: RateLimitSnapshot,
) -> RateLimitSnapshot {
    if snapshot.limit_id.is_none() {
        snapshot.limit_id = Some("dcode".to_string());
    }
