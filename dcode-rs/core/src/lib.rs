//! Root of the `dcode-core` library.
...
pub use dcode::SteerInputError;
mod dcode_thread;
mod compact_remote;
pub use dcode_thread::DcodeThread;
pub use dcode_thread::ThreadConfigSnapshot;
mod agent;
mod dcode_delegate;
...
mod text_encoding;
pub use dcode_login::token_data;
mod truncate;
mod unified_exec;
...
#[deprecated(note = "use DcodeThread")]
pub type DcodeConversation = DcodeThread;
...
/// Default Dcode HTTP client headers and reqwest construction.
///
/// Implemented in [`dcode_login::default_client`]; this module re-exports that API for crates
/// that import `dcode_core::default_client`.
...
pub mod util;
pub(crate) use dcode_protocol::protocol;
pub(crate) use dcode_shell_command::bash;
pub(crate) use dcode_shell_command::is_dangerous_command;
pub(crate) use dcode_shell_command::is_safe_command;
pub(crate) use dcode_shell_command::parse_command;
pub(crate) use dcode_shell_command::powershell;
