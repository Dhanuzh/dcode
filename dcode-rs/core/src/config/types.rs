...
pub use dcode_protocol::config_types::AltScreenMode;
pub use dcode_protocol::config_types::ApprovalsReviewer;
pub use dcode_protocol::config_types::ModeKind;
pub use dcode_protocol::config_types::Personality;
pub use dcode_protocol::config_types::ServiceTier;
pub use dcode_protocol::config_types::WebSearchMode;
...
pub struct McpServerConfig {
    ...
    /// When `false`, Dcode skips initializing this MCP server.
    #[serde(default = "default_enabled")]
    pub enabled: bool,

    /// When `true`, `dcode exec` exits with an error if this MCP server fails to initialize.
...
pub struct AnalyticsConfigToml {
    /// When `false`, disables analytics across Dcode product surfaces in this profile.
    pub enabled: Option<bool>,
}
...
pub struct FeedbackConfigToml {
    /// When `false`, disables the feedback flow across Dcode product surfaces.
    pub enabled: Option<bool>,
}
...
pub struct AppConfig {
    /// When `false`, Dcode does not surface this app.
    #[serde(default = "default_enabled")]
    pub enabled: bool,
...
/// (primarily the Dcode IDE extension). NOTE: these are different from
...
pub struct Notice {
    ...
    /// Tracks whether the user has seen the gpt-5.1-dcode-max migration prompt
    #[serde(rename = "hide_gpt-5.1-dcode-max_migration_prompt")]
    pub hide_gpt_5_1_dcode_max_migration_prompt: Option<bool>,
...
impl From<SandboxWorkspaceWrite> for dcode_app_server_protocol::SandboxSettings {
