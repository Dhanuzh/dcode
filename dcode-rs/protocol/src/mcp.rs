...
//! `schemars`) so they can be embedded in Dcode's own protocol structures.
...
// === Adapter helpers ===
//
// These types and conversions intentionally live in `dcode-protocol` so other crates can convert
