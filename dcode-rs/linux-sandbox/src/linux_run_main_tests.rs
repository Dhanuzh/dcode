...
use super::*;
#[cfg(test)]
use dcode_protocol::protocol::FileSystemSandboxPolicy;
#[cfg(test)]
use dcode_protocol::protocol::NetworkSandboxPolicy;
#[cfg(test)]
...
fn split_only_filesystem_policy_requires_direct_runtime_enforcement() {
    ...
    let policy = FileSystemSandboxPolicy::restricted(vec![
        dcode_protocol::permissions::FileSystemSandboxEntry {
            path: dcode_protocol::permissions::FileSystemPath::Special {
                value: dcode_protocol::permissions::FileSystemSpecialPath::CurrentWorkingDirectory,
            },
            access: dcode_protocol::permissions::FileSystemAccessMode::Write,
        },
        dcode_protocol::permissions::FileSystemSandboxEntry {
            path: dcode_protocol::permissions::FileSystemPath::Path { path: docs },
            access: dcode_protocol::permissions::FileSystemAccessMode::Read,
        },
    ]);
...
fn root_write_read_only_carveout_requires_direct_runtime_enforcement() {
    ...
    let policy = FileSystemSandboxPolicy::restricted(vec![
        dcode_protocol::permissions::FileSystemSandboxEntry {
            path: dcode_protocol::permissions::FileSystemPath::Special {
                value: dcode_protocol::permissions::FileSystemSpecialPath::Root,
            },
            access: dcode_protocol::permissions::FileSystemAccessMode::Write,
        },
        dcode_protocol::permissions::FileSystemSandboxEntry {
