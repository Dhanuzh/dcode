...
use dcode_windows_sandbox::dpapi_protect;
...
pub const SANDBOX_USERS_GROUP: &str = "DcodeSandboxUsers";
const SANDBOX_USERS_GROUP_COMMENT: &str = "Dcode sandbox internal group (managed)";
...
fn write_secrets(
    ...
    let sandbox_dir = sandbox_dir(dcode_home);
    ...
    let secrets_dir = sandbox_secrets_dir(dcode_home);
