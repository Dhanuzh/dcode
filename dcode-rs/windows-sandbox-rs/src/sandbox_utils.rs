...
//! dcode home directory creation and git safe.directory injection so sandboxed
...
/// Ensure the sandbox dcode home directory exists.
pub fn ensure_dcode_home_exists(p: &Path) -> Result<()> {
