...
use dcode_app_server_client::RemoteAppServerClient;
use dcode_app_server_client::RemoteAppServerConnectArgs;
use dcode_app_server_protocol::AuthMode as AppServerAuthMode;
use dcode_app_server_protocol::ConfigWarningNotification;
use dcode_app_server_protocol::Thread as AppServerThread;
use dcode_app_server_protocol::ThreadListParams;
use dcode_app_server_protocol::ThreadSortKey as AppServerThreadSortKey;
use dcode_app_server_protocol::ThreadSourceKind;
use dcode_cloud_requirements::cloud_requirements_loader_for_storage;
...
pub(crate) async fn start_app_server_for_picker(
    ...
    let app_server = start_app_server(
        ...
        dcode_feedback::DcodeFeedback::new(),
    )
    .await?;
    ...
    Fut: Future<Output = std::io::Result<InProcessAppServerClient>>,
{
    ...
    let client = start_client(InProcessClientStartArgs {
        ...
        feedback,
        config_warnings,
        session_source: dcode_protocol::protocol::SessionSource::Cli,
