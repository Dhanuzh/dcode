...
use dcode_core::auth::load_auth_dot_json;
...
pub(crate) fn load_local_chatgpt_auth(
    ...
    let auth = load_auth_dot_json(dcode_home, auth_credentials_store_mode)
...
mod tests {
    ...
    fn write_chatgpt_auth(dcode_home: &Path) {
        ...
        let auth = AuthDotJson {
            ...
            tokens: Some(TokenData {
                id_token: dcode_core::token_data::parse_chatgpt_jwt_claims(&id_token)
        ...
        save_auth(dcode_home, &auth, AuthCredentialsStoreMode::File)
    ...
    fn loads_local_chatgpt_auth_from_managed_auth() {
        ...
        write_chatgpt_auth(dcode_home.path());
    ...
    fn rejects_missing_local_auth() {
        ...
        let err = load_local_chatgpt_auth(dcode_home.path(), AuthCredentialsStoreMode::File, None)
