...
impl AppEventSender {
    ...
    pub(crate) fn send(&self, event: AppEvent) {
        ...
        if !matches!(event, AppEvent::DcodeOp(_)) {
    ...
    pub(crate) fn interrupt(&self) {
        self.send(AppEvent::DcodeOp(AppCommand::interrupt().into_core()));
    }

    pub(crate) fn compact(&self) {
        self.send(AppEvent::DcodeOp(AppCommand::compact().into_core()));
    }

    pub(crate) fn set_thread_name(&self, name: String) {
        self.send(AppEvent::DcodeOp(
