    ...
    fn prompt_snapshot() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                ...
                None,
                Some(
                    "Upgrade to gpt-5.2-dcode for the latest and greatest agentic coding model."
                        .to_string(),
                ),
                None,
                "gpt-5.1-dcode-max".to_string(),
                Some("Dcode-optimized flagship for deep and fast reasoning.".to_string()),
                true,
            ),
        );
    ...
    fn prompt_snapshot_gpt5_family() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-5",
                "gpt-5.1",
                Some("https://www.dcode.com/models/gpt-5.1".to_string()),
                None,
                None,
                "gpt-5.1".to_string(),
    ...
    fn prompt_snapshot_gpt5_dcode() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-5-dcode",
                "gpt-5.1-dcode-max",
                Some("https://www.dcode.com/models/gpt-5.1-dcode-max".to_string()),
                None,
                None,
                "gpt-5.1-dcode-max".to_string(),
                Some("Dcode-optimized flagship for deep and fast reasoning.".to_string()),
        ...
        terminal.flush().expect("flush");
        assert_snapshot!("model_migration_prompt_gpt5_dcode", terminal.backend());
    }

    #[test]
    fn prompt_snapshot_gpt5_dcode_mini() {
        let backend = VT100Backend::new(60, 22);
        let mut terminal = Terminal::with_options(backend).expect("terminal");
        terminal.set_viewport_area(Rect::new(0, 0, 60, 22));
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-5-dcode-mini",
                "gpt-5.1-dcode-mini",
                Some("https://www.dcode.com/models/gpt-5.1-dcode-mini".to_string()),
                None,
                None,
                "gpt-5.1-dcode-mini".to_string(),
                Some("Optimized for dcode. Cheaper, faster, but less capable.".to_string()),
                false,
            ),
        );
        {
        ...
        terminal.flush().expect("flush");
        assert_snapshot!("model_migration_prompt_gpt5_dcode_mini", terminal.backend());
    }
    ...
    fn escape_key_accepts_prompt() {
        let mut screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-old",
                "gpt-new",
                Some("https://www.dcode.com/models/gpt-new".to_string()),
                None,
                None,
                "gpt-new".to_string(),
