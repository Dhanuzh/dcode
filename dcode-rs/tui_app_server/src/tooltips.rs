...
const ANNOUNCEMENT_TIP_URL: &str =
    "https://raw.githubusercontent.com/openai/dcode/main/announcement_tip.toml";

const IS_MACOS: bool = cfg!(target_os = "macos");
const IS_WINDOWS: bool = cfg!(target_os = "windows");

const PAID_TOOLTIP: &str = "*New* Try the **Dcode App** with 2x rate limits until *April 2nd*. Run 'dcode app' or visit https://chatgpt.com/dcode?app-landing-page=true";
const PAID_TOOLTIP_WINDOWS: &str = "*New* Try the **Dcode App**, now available on **Windows**, with 2x rate limits until *April 2nd*. Run 'dcode app' or visit https://chatgpt.com/dcode?app-landing-page=true";
...
const OTHER_TOOLTIP: &str = "*New* Build faster with the **Dcode App**. Run 'dcode app' or visit https://chatgpt.com/dcode?app-landing-page=true";
