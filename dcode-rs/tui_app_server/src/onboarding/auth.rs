...
fn onboarding_request_id() -> dcode_app_server_protocol::RequestId {
    dcode_app_server_protocol::RequestId::String(Uuid::new_v4().to_string())
}
                    ...
                    SignInState::ChatGptContinueInBrowser(state) => {
                        ...
                        tokio::spawn(async move {
                            let _ = request_handle
                                .request_typed::<dcode_app_server_protocol::CancelLoginAccountResponse>(
