...
4. Dcode: OpenAI's coding agent for software development that can write, understand, review, and debug code.
...
1. Run the install command yourself: `dcode mcp add openaiDeveloperDocs --url https://developers.openai.com/mcp`
...
4. Ask the user to restart Dcode.
