    ...
    while let Some(event) = incoming_rx.recv().await {
        match event {
            ...
            JsonRpcConnectionEvent::Message(message) => match message {
                dcode_app_server_protocol::JSONRPCMessage::Request(request) => {
                ...
                dcode_app_server_protocol::JSONRPCMessage::Notification(notification) => {
                ...
                dcode_app_server_protocol::JSONRPCMessage::Response(response) => {
                    warn!(
                ...
                dcode_app_server_protocol::JSONRPCMessage::Error(error) => {
                    warn!(
