...
const RESOURCE_URI: &str = "memo://dcode/example-note";

fn stdio_server_bin() -> Result<PathBuf, CargoBinError> {
    dcode_utils_cargo_bin::cargo_bin("test_stdio_server")
}
...
fn init_params() -> InitializeRequestParams {
    InitializeRequestParams {
        ...
        client_info: Implementation {
            name: "dcode-test".into(),
            version: "0.0.0-test".into(),
            title: Some("Dcode rmcp resource test".into()),
            description: None,
            icons: None,
            website_url: None,
        },
