...
pub struct AuthEnvTelemetryMetadata {
    ...
    pub dcode_api_key_env_present: bool,
    pub dcode_api_key_env_enabled: bool,
...
impl SessionTelemetry {
    ...
    pub fn conversation_starts(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "dcode.conversation_starts",
                provider_name = %provider_name,
                auth.env_openai_api_key_present = self.metadata.auth_env.openai_api_key_env_present,
                auth.env_dcode_api_key_present = self.metadata.auth_env.dcode_api_key_env_present,
                auth.env_dcode_api_key_enabled = self.metadata.auth_env.dcode_api_key_env_enabled,
    ...
    pub fn record_websocket_connect(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "dcode.websocket_connect",
                duration_ms = %duration.as_millis(),
                http.response.status_code = status,
                success = success_str,
                error.message = error,
    ...
    pub fn record_websocket_request(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "dcode.websocket_request",
                duration_ms = %duration.as_millis(),
                success = success_str,
                error.message = error,
                auth.env_openai_api_key_present = self.metadata.auth_env.openai_api_key_env_present,
    ...
    pub fn record_auth_recovery(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "dcode.auth_recovery",
                auth.mode = mode,
                auth.step = step,
    ...
    pub fn record_websocket_event(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "dcode.websocket_event",
                event.kind = %kind_str,
                duration_ms = %duration.as_millis(),
                success = success_str,
    ...
    pub fn tool_decision(
        ...
        log_event!(
            self,
            event.name = "dcode.tool_decision",
            tool_name = %tool_name,
            call_id = %call_id,
