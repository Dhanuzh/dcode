pub(crate) const OTEL_TARGET_PREFIX: &str = "dcode_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "dcode_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "dcode_otel.trace_safe";
