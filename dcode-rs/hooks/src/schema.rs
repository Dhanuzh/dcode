...
pub(crate) struct PreToolUseCommandInput {
    ...
    /// Dcode extension: expose the active turn id to internal turn-scoped hooks.
    pub turn_id: String,
...
mod tests {
    ...
    #[test]
    fn turn_scoped_hook_inputs_include_dcode_turn_id_extension() {
        // Dcode intentionally diverges from Claude's public hook docs here so
