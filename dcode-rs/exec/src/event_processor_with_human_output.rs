...
use dcode_protocol::num_format::format_with_separators;
...
use dcode_protocol::protocol::HookCompletedEvent;
use dcode_protocol::protocol::HookEventName;
use dcode_protocol::protocol::HookOutputEntryKind;
use dcode_protocol::protocol::HookRunStatus;
use dcode_protocol::protocol::HookStartedEvent;
...
use dcode_utils_elapsed::format_duration;
use dcode_utils_elapsed::format_elapsed;
...
use dcode_utils_sandbox_summary::create_config_summary_entries;
...
pub(crate) struct EventProcessorWithHumanOutput {
    ...
    last_total_token_usage: Option<dcode_protocol::protocol::TokenUsageInfo>,
...
impl EventProcessor for EventProcessorWithHumanOutput {
    ...
    fn print_config_summary(
        ...
        ts_msg!(
            self,
            "OpenAI Dcode v{} (research preview)\n--------",
            VERSION
        );
    ...
    fn process_event(&mut self, event: Event) -> DcodeStatus {
        ...
        match msg {
            ...
            EventMsg::McpStartupUpdate(update) => {
                let status_text = match update.status {
                    dcode_protocol::protocol::McpStartupStatus::Starting => "starting".to_string(),
                    dcode_protocol::protocol::McpStartupStatus::Ready => "ready".to_string(),
                    dcode_protocol::protocol::McpStartupStatus::Cancelled => {
                        "cancelled".to_string()
                    }
                    dcode_protocol::protocol::McpStartupStatus::Failed { ref error } => {
                        format!("failed: {error}")
                    }
                };
                ts_msg!(
            ...
            EventMsg::TurnComplete(TurnCompleteEvent {
                ...
                return DcodeStatus::InitiateShutdown;
            }
            ...
            EventMsg::AgentMessage(AgentMessageEvent { message, .. }) => {
                ts_msg!(
                    self,
                    "{}\n{}",
                    "dcode".style(self.italic).style(self.magenta),
                    message,
                );
            }
            ...
            EventMsg::SessionConfigured(session_configured_event) => {
                ...
                ts_msg!(
                    self,
                    "{} {}",
                    "dcode session".style(self.magenta).style(self.bold),
            ...
            EventMsg::ShutdownComplete => return DcodeStatus::Shutdown,
...
fn format_receiver_list(ids: &[dcode_protocol::ThreadId]) -> String {
    if ids.is_empty() {
...
mod tests {
    ...
    use dcode_protocol::protocol::HookCompletedEvent;
    use dcode_protocol::protocol::HookEventName;
    use dcode_protocol::protocol::HookExecutionMode;
    use dcode_protocol::protocol::HookHandlerType;
    use dcode_protocol::protocol::HookOutputEntry;
    use dcode_protocol::protocol::HookRunStatus;
    use dcode_protocol::protocol::HookRunSummary;
    use dcode_protocol::protocol::HookScope;
    use dcode_protocol::protocol::HookStartedEvent;
