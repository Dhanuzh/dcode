...
pub struct EventProcessorWithJsonOutput {
    ...
    last_total_token_usage: Option<dcode_protocol::protocol::TokenUsage>,
    ...
    pub fn collect_thread_events(&mut self, event: &protocol::Event) -> Vec<ThreadEvent> {
        match &event.msg {
            ...
            protocol::EventMsg::ItemCompleted(protocol::ItemCompletedEvent {
                item: dcode_protocol::items::TurnItem::Plan(item),
                ..
            }) => {
...
impl EventProcessor for EventProcessorWithJsonOutput {
    ...
    fn process_event(&mut self, event: protocol::Event) -> DcodeStatus {
        ...
        match msg {
            ...
            protocol::EventMsg::TurnAborted(_) => DcodeStatus::InitiateShutdown,
            protocol::EventMsg::ShutdownComplete => DcodeStatus::Shutdown,
            _ => DcodeStatus::Running,
        }
    }
}
