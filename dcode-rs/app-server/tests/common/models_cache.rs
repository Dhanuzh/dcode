use chrono::DateTime;
use chrono::Utc;
use dcode_core::test_support::all_model_presets;
...
/// Write a models_cache.json file to the dcode home directory.
/// This prevents ModelsManager from making network requests to refresh models.
/// The cache will be treated as fresh (within TTL) and used instead of fetching from the network.
/// Uses bundled-catalog-derived presets, converted to ModelInfo format.
pub fn write_models_cache(dcode_home: &Path) -> std::io::Result<()> {
    ...
    write_models_cache_with_models(dcode_home, models)
}
...
pub fn write_models_cache_with_models(
    ...
    let cache_path = dcode_home.join("models_cache.json");
