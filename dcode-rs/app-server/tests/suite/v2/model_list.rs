...
use dcode_app_server_protocol::Model;
use dcode_app_server_protocol::ModelListParams;
use dcode_app_server_protocol::ModelListResponse;
use dcode_app_server_protocol::ModelUpgradeInfo;
use dcode_app_server_protocol::ReasoningEffortOption;
...
fn expected_visible_models() -> Vec<Model> {
    ...
    let mut presets =
        ModelPreset::filter_by_auth(dcode_core::test_support::all_model_presets().clone(), false);
