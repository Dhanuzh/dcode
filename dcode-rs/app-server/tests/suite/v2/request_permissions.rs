...
async fn request_permissions_round_trip() -> Result<()> {
    let dcode_home = tempfile::TempDir::new()?;
    let responses = vec![
    ...
    mcp.send_response(
        ...
        serde_json::to_value(PermissionsRequestApprovalResponse {
            permissions: dcode_app_server_protocol::GrantedPermissionProfile {
                network: None,
                file_system: Some(dcode_app_server_protocol::AdditionalFileSystemPermissions {
                    read: None,
