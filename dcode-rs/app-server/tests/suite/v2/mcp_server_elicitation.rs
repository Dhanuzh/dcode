...
const QUALIFIED_TOOL_NAME: &str = "mcp__dcode_apps__calendar_confirm_action";
...
async fn mcp_server_elicitation_round_trip() -> Result<()> {
    ...
    write_config_toml(dcode_home.path(), &responses_server.uri(), &apps_server_url)?;
    write_chatgpt_auth(
        dcode_home.path(),
    ...
    assert_eq!(
        ...
        McpServerElicitationRequestParams {
            ...
            server_name: "dcode_apps".to_string(),
...
async fn start_apps_server() -> Result<(String, JoinHandle<()>)> {
    ...
    let router = Router::new()
        ...
        .with_state(state)
        .nest_service("/api/dcode/apps", mcp_service);
