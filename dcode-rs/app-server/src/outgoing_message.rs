...
use dcode_otel::span_w3c_trace_context;
...
mod tests {
    ...
    use dcode_app_server_protocol::ModelRerouteReason;
    use dcode_app_server_protocol::ModelReroutedNotification;
    use dcode_app_server_protocol::RateLimitSnapshot;
    use dcode_app_server_protocol::RateLimitWindow;
    ...
    fn verify_model_rerouted_notification_serialization() {
        let notification = ServerNotification::ModelRerouted(ModelReroutedNotification {
            ...
            from_model: "gpt-5.3-dcode".to_string(),
