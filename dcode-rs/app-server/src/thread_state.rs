...
type PendingInterruptQueue = Vec<(
    ConnectionRequestId,
    crate::dcode_message_processor::ApiVersion,
)>;
...
pub(crate) struct PendingThreadResumeRequest {
    ...
    pub(crate) thread_summary: dcode_app_server_protocol::Thread,
}
...
pub(crate) struct ThreadState {
    ...
    listener_thread: Option<Weak<DcodeThread>>,
}

impl ThreadState {
    pub(crate) fn listener_matches(&self, conversation: &Arc<DcodeThread>) -> bool {
