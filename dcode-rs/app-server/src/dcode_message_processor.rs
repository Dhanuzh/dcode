...
use chrono::Utc;
use dcode_app_server_protocol::Account;
use dcode_app_server_protocol::AccountLoginCompletedNotification;
use dcode_app_server_protocol::AccountUpdatedNotification;
use dcode_app_server_protocol::AppInfo;
use dcode_app_server_protocol::AppsListParams;
use dcode_app_server_protocol::AppsListResponse;
use dcode_app_server_protocol::AskForApproval;
use dcode_app_server_protocol::AuthMode;
use dcode_app_server_protocol::CancelLoginAccountParams;
use dcode_app_server_protocol::CancelLoginAccountResponse;
use dcode_app_server_protocol::CancelLoginAccountStatus;
use dcode_app_server_protocol::ClientRequest;
use dcode_app_server_protocol::DcodeErrorInfo as AppServerDcodeErrorInfo;
use dcode_app_server_protocol::CollaborationModeListParams;
use dcode_app_server_protocol::CollaborationModeListResponse;
use dcode_app_server_protocol::CommandExecParams;
use dcode_app_server_protocol::CommandExecResizeParams;
use dcode_app_server_protocol::CommandExecTerminateParams;
use dcode_app_server_protocol::CommandExecWriteParams;
use dcode_app_server_protocol::ConversationGitInfo;
use dcode_app_server_protocol::ConversationSummary;
use dcode_app_server_protocol::DynamicToolSpec as ApiDynamicToolSpec;
use dcode_app_server_protocol::ExperimentalFeature as ApiExperimentalFeature;
use dcode_app_server_protocol::ExperimentalFeatureListParams;
use dcode_app_server_protocol::ExperimentalFeatureListResponse;
use dcode_app_server_protocol::ExperimentalFeatureStage as ApiExperimentalFeatureStage;
use dcode_app_server_protocol::FeedbackUploadParams;
use dcode_app_server_protocol::FeedbackUploadResponse;
use dcode_app_server_protocol::FuzzyFileSearchParams;
use dcode_app_server_protocol::FuzzyFileSearchResponse;
use dcode_app_server_protocol::FuzzyFileSearchSessionStartParams;
use dcode_app_server_protocol::FuzzyFileSearchSessionStartResponse;
use dcode_app_server_protocol::FuzzyFileSearchSessionStopParams;
use dcode_app_server_protocol::FuzzyFileSearchSessionStopResponse;
use dcode_app_server_protocol::FuzzyFileSearchSessionUpdateParams;
use dcode_app_server_protocol::FuzzyFileSearchSessionUpdateResponse;
use dcode_app_server_protocol::GetAccountParams;
use dcode_app_server_protocol::GetAccountRateLimitsResponse;
use dcode_app_server_protocol::GetAccountResponse;
use dcode_app_server_protocol::GetAuthStatusParams;
use dcode_app_server_protocol::GetAuthStatusResponse;
use dcode_app_server_protocol::GetConversationSummaryParams;
use dcode_app_server_protocol::GetConversationSummaryResponse;
use dcode_app_server_protocol::GitDiffToRemoteResponse;
use dcode_app_server_protocol::GitInfo as ApiGitInfo;
use dcode_app_server_protocol::JSONRPCErrorError;
use dcode_app_server_protocol::ListMcpServerStatusParams;
use dcode_app_server_protocol::ListMcpServerStatusResponse;
use dcode_app_server_protocol::LoginAccountParams;
use dcode_app_server_protocol::LoginAccountResponse;
use dcode_app_server_protocol::LoginApiKeyParams;
use dcode_app_server_protocol::LogoutAccountResponse;
use dcode_app_server_protocol::MarketplaceInterface;
use dcode_app_server_protocol::McpServerOauthLoginCompletedNotification;
use dcode_app_server_protocol::McpServerOauthLoginParams;
use dcode_app_server_protocol::McpServerOauthLoginResponse;
use dcode_app_server_protocol::McpServerRefreshResponse;
use dcode_app_server_protocol::McpServerStatus;
use dcode_app_server_protocol::MockExperimentalMethodParams;
use dcode_app_server_protocol::MockExperimentalMethodResponse;
use dcode_app_server_protocol::ModelListParams;
use dcode_app_server_protocol::ModelListResponse;
use dcode_app_server_protocol::PluginDetail;
use dcode_app_server_protocol::PluginInstallParams;
use dcode_app_server_protocol::PluginInstallResponse;
use dcode_app_server_protocol::PluginInterface;
use dcode_app_server_protocol::PluginListParams;
use dcode_app_server_protocol::PluginListResponse;
use dcode_app_server_protocol::PluginMarketplaceEntry;
use dcode_app_server_protocol::PluginReadParams;
use dcode_app_server_protocol::PluginReadResponse;
use dcode_app_server_protocol::PluginSource;
use dcode_app_server_protocol::PluginSummary;
...
use dcode_app_server_protocol::ReviewDelivery as ApiReviewDelivery;
use dcode_app_server_protocol::ReviewStartParams;
use dcode_app_server_protocol::ReviewStartResponse;
use dcode_app_server_protocol::ReviewTarget as ApiReviewTarget;
use dcode_app_server_protocol::SandboxMode;
use dcode_app_server_protocol::ServerNotification;
use dcode_app_server_protocol::ServerRequestResolvedNotification;
use dcode_app_server_protocol::SkillSummary;
use dcode_app_server_protocol::SkillsConfigWriteParams;
use dcode_app_server_protocol::SkillsConfigWriteResponse;
use dcode_app_server_protocol::SkillsListParams;
use dcode_app_server_protocol::SkillsListResponse;
use dcode_app_server_protocol::Thread;
use dcode_app_server_protocol::ThreadArchiveParams;
use dcode_app_server_protocol::ThreadArchiveResponse;
use dcode_app_server_protocol::ThreadArchivedNotification;
use dcode_app_server_protocol::ThreadBackgroundTerminalsCleanParams;
use dcode_app_server_protocol::ThreadBackgroundTerminalsCleanResponse;
use dcode_app_server_protocol::ThreadClosedNotification;
use dcode_app_server_protocol::ThreadCompactStartParams;
use dcode_app_server_protocol::ThreadCompactStartResponse;
use dcode_app_server_protocol::ThreadDecrementElicitationParams;
use dcode_app_server_protocol::ThreadDecrementElicitationResponse;
use dcode_app_server_protocol::ThreadForkParams;
use dcode_app_server_protocol::ThreadForkResponse;
use dcode_app_server_protocol::ThreadIncrementElicitationParams;
use dcode_app_server_protocol::ThreadIncrementElicitationResponse;
use dcode_app_server_protocol::ThreadItem;
use dcode_app_server_protocol::ThreadListParams;
use dcode_app_server_protocol::ThreadListResponse;
use dcode_app_server_protocol::ThreadLoadedListParams;
use dcode_app_server_protocol::ThreadLoadedListResponse;
use dcode_app_server_protocol::ThreadMetadataGitInfoUpdateParams;
use dcode_app_server_protocol::ThreadMetadataUpdateParams;
use dcode_app_server_protocol::ThreadMetadataUpdateResponse;
use dcode_app_server_protocol::ThreadNameUpdatedNotification;
use dcode_app_server_protocol::ThreadReadParams;
use dcode_app_server_protocol::ThreadReadResponse;
use dcode_app_server_protocol::ThreadRealtimeAppendAudioParams;
use dcode_app_server_protocol::ThreadRealtimeAppendAudioResponse;
use dcode_app_server_protocol::ThreadRealtimeAppendTextParams;
use dcode_app_server_protocol::ThreadRealtimeAppendTextResponse;
use dcode_app_server_protocol::ThreadRealtimeStartParams;
use dcode_app_server_protocol::ThreadRealtimeStartResponse;
use dcode_app_server_protocol::ThreadRealtimeStopParams;
use dcode_app_server_protocol::ThreadRealtimeStopResponse;
use dcode_app_server_protocol::ThreadResumeParams;
use dcode_app_server_protocol::ThreadResumeResponse;
use dcode_app_server_protocol::ThreadRollbackParams;
use dcode_app_server_protocol::ThreadSetNameParams;
use dcode_app_server_protocol::ThreadSetNameResponse;
use dcode_app_server_protocol::ThreadShellCommandParams;
use dcode_app_server_protocol::ThreadShellCommandResponse;
use dcode_app_server_protocol::ThreadSortKey;
use dcode_app_server_protocol::ThreadSourceKind;
use dcode_app_server_protocol::ThreadStartParams;
use dcode_app_server_protocol::ThreadStartResponse;
use dcode_app_server_protocol::ThreadStartedNotification;
use dcode_app_server_protocol::ThreadStatus;
use dcode_app_server_protocol::ThreadUnarchiveParams;
use dcode_app_server_protocol::ThreadUnarchiveResponse;
use dcode_app_server_protocol::ThreadUnarchivedNotification;
use dcode_app_server_protocol::ThreadUnsubscribeParams;
use dcode_app_server_protocol::ThreadUnsubscribeResponse;
use dcode_app_server_protocol::ThreadUnsubscribeStatus;
use dcode_app_server_protocol::Turn;
use dcode_app_server_protocol::TurnError;
use dcode_app_server_protocol::TurnInterruptParams;
use dcode_app_server_protocol::TurnStartParams;
use dcode_app_server_protocol::TurnStartResponse;
use dcode_app_server_protocol::TurnStatus;
use dcode_app_server_protocol::TurnSteerParams;
use dcode_app_server_protocol::TurnSteerResponse;
use dcode_app_server_protocol::UserInput as V2UserInput;
use dcode_app_server_protocol::WindowsSandboxSetupCompletedNotification;
use dcode_app_server_protocol::WindowsSandboxSetupMode;
use dcode_app_server_protocol::WindowsSandboxSetupStartParams;
use dcode_app_server_protocol::WindowsSandboxSetupStartResponse;
use dcode_app_server_protocol::build_turns_from_rollout_items;
use dcode_arg0::Arg0DispatchPaths;
use dcode_backend_client::Client as BackendClient;
use dcode_chatgpt::connectors;
use dcode_cloud_requirements::cloud_requirements_loader;
use dcode_core::AuthManager;
use dcode_core::DcodeAuth;
use dcode_core::DcodeThread;
use dcode_core::Cursor as RolloutCursor;
use dcode_core::ForkSnapshot;
use dcode_core::NewThread;
use dcode_core::RolloutRecorder;
use dcode_core::SessionMeta;
use dcode_core::SteerInputError;
use dcode_core::ThreadConfigSnapshot;
use dcode_core::ThreadManager;
use dcode_core::ThreadSortKey as CoreThreadSortKey;
use dcode_core::auth::AuthMode as CoreAuthMode;
...
use dcode_core::config::NetworkProxyAuditMetadata;
...
use dcode_core::config_loader::CloudRequirementsLoadError;
use dcode_core::config_loader::CloudRequirementsLoadErrorCode;
use dcode_core::config_loader::CloudRequirementsLoader;
use dcode_core::default_client::set_default_client_residency_requirement;
use dcode_core::error::DcodeErr;
use dcode_core::error::Result as DcodeResult;
use dcode_core::exec::ExecCapturePolicy;
use dcode_core::exec::ExecExpiration;
use dcode_core::exec::ExecParams;
use dcode_core::exec_env::create_env;
use dcode_core::find_archived_thread_path_by_id_str;
use dcode_core::find_thread_name_by_id;
use dcode_core::find_thread_names_by_ids;
use dcode_core::find_thread_path_by_id_str;
use dcode_core::git_info::git_diff_to_remote;
use dcode_core::mcp::auth::discover_supported_scopes;
use dcode_core::mcp::auth::resolve_oauth_scopes;
use dcode_core::mcp::collect_mcp_snapshot;
use dcode_core::mcp::group_tools_by_server;
use dcode_core::models_manager::collaboration_mode_presets::CollaborationModesConfig;
use dcode_core::parse_cursor;
use dcode_core::plugins::MarketplaceError;
use dcode_core::plugins::MarketplacePluginSource;
use dcode_core::plugins::OPENAI_CURATED_MARKETPLACE_NAME;
use dcode_core::plugins::PluginInstallError as CorePluginInstallError;
use dcode_core::plugins::PluginInstallRequest;
use dcode_core::plugins::PluginReadRequest;
use dcode_core::plugins::PluginUninstallError as CorePluginUninstallError;
use dcode_core::plugins::load_plugin_apps;
use dcode_core::plugins::load_plugin_mcp_servers;
use dcode_core::read_head_for_summary;
use dcode_core::read_session_meta_line;
use dcode_core::rollout_date_parts;
use dcode_core::sandboxing::SandboxPermissions;
use dcode_core::state_db::StateDbHandle;
use dcode_core::state_db::get_state_db;
use dcode_core::state_db::reconcile_rollout;
use dcode_core::windows_sandbox::WindowsSandboxLevelExt;
use dcode_core::windows_sandbox::WindowsSandboxSetupMode as CoreWindowsSandboxSetupMode;
use dcode_core::windows_sandbox::WindowsSandboxSetupRequest;
use dcode_features::FEATURES;
use dcode_features::Feature;
use dcode_features::Stage;
use dcode_feedback::DcodeFeedback;
use dcode_login::ServerOptions as LoginServerOptions;
use dcode_login::ShutdownHandle;
use dcode_login::auth::login_with_chatgpt_auth_tokens;
...
use dcode_protocol::dynamic_tools::DynamicToolSpec as CoreDynamicToolSpec;
use dcode_protocol::items::TurnItem;
use dcode_protocol::models::ResponseItem;
use dcode_protocol::protocol::AgentStatus;
use dcode_protocol::protocol::ConversationAudioParams;
use dcode_protocol::protocol::ConversationStartParams;
use dcode_protocol::protocol::ConversationTextParams;
use dcode_protocol::protocol::EventMsg;
use dcode_protocol::protocol::GitInfo as CoreGitInfo;
use dcode_protocol::protocol::InitialHistory;
use dcode_protocol::protocol::McpAuthStatus as CoreMcpAuthStatus;
use dcode_protocol::protocol::McpServerRefreshConfig;
use dcode_protocol::protocol::Op;
use dcode_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use dcode_protocol::protocol::ReviewDelivery as CoreReviewDelivery;
use dcode_protocol::protocol::ReviewRequest;
use dcode_protocol::protocol::ReviewTarget as CoreReviewTarget;
...
use dcode_protocol::protocol::USER_MESSAGE_BEGIN;
use dcode_protocol::protocol::W3cTraceContext;
use dcode_protocol::user_input::MAX_USER_INPUT_TEXT_CHARS;
use dcode_protocol::user_input::UserInput as CoreInputItem;
use dcode_rmcp_client::perform_oauth_login_return_url;
use dcode_state::StateRuntime;
use dcode_state::ThreadMetadata;
use dcode_state::ThreadMetadataBuilder;
use dcode_state::log_db::LogDbLayer;
use dcode_utils_json_to_toml::json_to_toml;
use dcode_utils_pty::DEFAULT_OUTPUT_BYTES_CAP;
...
#[cfg(test)]
use dcode_app_server_protocol::ServerRequest;
...
/// Handles JSON-RPC messages for Dcode threads (and legacy conversation APIs).
pub(crate) struct DcodeMessageProcessor {
...
pub(crate) struct DcodeMessageProcessorArgs {
    ...
    pub(crate) feedback: DcodeFeedback,
    pub(crate) log_db: Option<LogDbLayer>,
}

impl DcodeMessageProcessor {
    ...
    fn current_account_updated_notification(&self) -> AccountUpdatedNotification {
        ...
        AccountUpdatedNotification {
            auth_mode: auth.as_ref().map(DcodeAuth::api_auth_mode),
            plan_type: auth.as_ref().and_then(DcodeAuth::account_plan_type),
        }
    }
    ...
    async fn load_thread(
        &self,
        thread_id: &str,
    ) -> Result<(ThreadId, Arc<DcodeThread>), JSONRPCErrorError> {
    ...
    pub fn new(args: DcodeMessageProcessorArgs) -> Self {
        let DcodeMessageProcessorArgs {
            auth_manager,
            thread_manager,
            outgoing,
            arg0_paths,
    ...
    async fn load_latest_config(
        ...
        let mut config = dcode_core::config::ConfigBuilder::default()
        ...
        config.dcode_linux_sandbox_exe = self.arg0_paths.dcode_linux_sandbox_exe.clone();
    ...
    fn review_request_from_target(
        ...
        let hint = dcode_core::review_prompts::user_facing_hint(&core_target);
    ...
    pub async fn process_request(
        ...
        match request {
            ...
            | ClientRequest::ConfigBatchWrite { .. } => {
                warn!("Config request reached DcodeMessageProcessor unexpectedly");
            }
            ...
            | ClientRequest::FsCopy { .. } => {
                warn!("Filesystem request reached DcodeMessageProcessor unexpectedly");
            }
            ClientRequest::ConfigRequirementsRead { .. } => {
                warn!("ConfigRequirementsRead request reached DcodeMessageProcessor unexpectedly");
            }
            ClientRequest::ExternalAgentConfigDetect { .. }
            | ClientRequest::ExternalAgentConfigImport { .. } => {
                warn!("ExternalAgentConfig request reached DcodeMessageProcessor unexpectedly");
            }
    ...
    async fn login_api_key_v2(
        ...
        match self.login_api_key_common(&params).await {
            Ok(()) => {
                let response = dcode_app_server_protocol::LoginAccountResponse::ApiKey {};
        ...
        match self.login_chatgpt_common().await {
            Ok(opts) => match run_login_server(opts) {
                Ok(server) => {
                    ...
                    let response = dcode_app_server_protocol::LoginAccountResponse::Chatgpt {
    ...
    > {
        let Some(auth) = self.auth_manager.auth().await else {
            return Err(JSONRPCErrorError {
                code: INVALID_REQUEST_ERROR_CODE,
                message: "dcode account authentication required to read rate limits".to_string(),
                data: None,
            });
        };
        ...
        let snapshots = client
            ...
            .map_err(|err| JSONRPCErrorError {
                code: INTERNAL_ERROR_CODE,
                message: format!("failed to fetch dcode rate limits: {err}"),
                data: None,
            })?;
        if snapshots.is_empty() {
            return Err(JSONRPCErrorError {
                code: INTERNAL_ERROR_CODE,
                message: "failed to fetch dcode rate limits: no snapshots returned".to_string(),
                data: None,
            });
        }
        ...
        let primary = snapshots
            .iter()
            .find(|snapshot| snapshot.limit_id.as_deref() == Some("dcode"))
            .cloned()
    ...
    async fn exec_one_off_command(
        ...
        let exec_params = ExecParams {
            ...
            network: started_network_proxy
                .as_ref()
                .map(dcode_core::config::StartedNetworkProxy::proxy),
            ...
            Some(policy) => match self.config.permissions.sandbox_policy.can_set(&policy) {
                Ok(()) => {
                    let file_system_sandbox_policy =
                        dcode_protocol::permissions::FileSystemSandboxPolicy::from_legacy_sandbox_policy(&policy, &sandbox_cwd);
                    let network_sandbox_policy =
                        dcode_protocol::permissions::NetworkSandboxPolicy::from(&policy);
        ...
        let dcode_linux_sandbox_exe = self.arg0_paths.dcode_linux_sandbox_exe.clone();
        let outgoing = self.outgoing.clone();
        ...
        match dcode_core::exec::build_exec_request(
            exec_params,
            &effective_policy,
            &effective_file_system_sandbox_policy,
            effective_network_sandbox_policy,
            sandbox_cwd.as_path(),
            &dcode_linux_sandbox_exe,
            use_legacy_landlock,
        ) {
            Ok(exec_request) => {
    ...
    async fn request_trace_context(
        &self,
        request_id: &ConnectionRequestId,
    ) -> Option<dcode_protocol::protocol::W3cTraceContext> {
    ...
    async fn thread_start_task(
        ...
        let config = match derive_config_from_params(
            ...
            typesafe_overrides,
            &cloud_requirements,
            &listener_task_context.dcode_home,
        )
        .await
        {
            Ok(config) => config,
    ...
    fn build_thread_config_overrides(
        ...
        service_tier: Option<Option<dcode_protocol::config_types::ServiceTier>>,
        cwd: Option<String>,
        approval_policy: Option<dcode_app_server_protocol::AskForApproval>,
        approvals_reviewer: Option<dcode_app_server_protocol::ApprovalsReviewer>,
        ...
        ConfigOverrides {
            ...
            approval_policy: approval_policy
                .map(dcode_app_server_protocol::AskForApproval::to_core),
            approvals_reviewer: approvals_reviewer
                .map(dcode_app_server_protocol::ApprovalsReviewer::to_core),
            sandbox_mode: sandbox.map(SandboxMode::to_core),
            dcode_linux_sandbox_exe: self.arg0_paths.dcode_linux_sandbox_exe.clone(),
    ...
    async fn thread_archive(
        ...
        let rollout_path =
            match find_thread_path_by_id_str(&self.config.dcode_home, &thread_id.to_string()).await
            {
                Ok(Some(p)) => p,
                Ok(None) => {
                    let error = JSONRPCErrorError {
    ...
    async fn thread_decrement_elicitation(
        ...
        match thread.decrement_out_of_band_elicitation_count().await {
            ...
            Err(DcodeErr::InvalidRequest(message)) => {
    ...
    async fn thread_set_name(&self, request_id: ConnectionRequestId, params: ThreadSetNameParams) {
        ...
        if let Err(err) =
            dcode_core::append_thread_name(&self.config.dcode_home, thread_id, &name).await
        {
            self.send_internal_error(request_id, format!("failed to set thread name: {err}"))
                .await;
            return;
    ...
    async fn ensure_thread_metadata_row_exists(
        ...
        loaded_thread: Option<&Arc<DcodeThread>>,
        ...
        let rollout_path =
            match find_thread_path_by_id_str(&self.config.dcode_home, &thread_uuid.to_string())
                .await
            {
                Ok(Some(path)) => path,
    ...
    async fn thread_unarchive(
        ...
        let archived_folder = self
            .config
            .dcode_home
            .join(dcode_core::ARCHIVED_SESSIONS_SUBDIR);
        ...
        let result: Result<Thread, JSONRPCErrorError> = async {
            ...
            let sessions_folder = self.config.dcode_home.join(dcode_core::SESSIONS_SUBDIR);
    ...
    async fn thread_list(&self, request_id: ConnectionRequestId, params: ThreadListParams) {
        ...
        let names = match find_thread_names_by_ids(&self.config.dcode_home, &thread_ids).await {
            Ok(names) => names,
            Err(err) => {
    ...
    async fn attach_thread_name(&self, thread_id: ThreadId, thread: &mut Thread) {
        match find_thread_name_by_id(&self.config.dcode_home, &thread_id).await {
            Ok(name) => {
                thread.name = name;
            }
            Err(err) => {
            ...
            .await
        {
            ...
            Err(err) => {
                match err {
                    ...
                    DcodeErr::InvalidRequest(message) => {
                        self.send_invalid_request_error(request_id, message).await;
                    }
                    _ => {
                        self.send_internal_error(
        ...
        let path = match params {
            GetConversationSummaryParams::RolloutPath { rollout_path } => {
                if rollout_path.is_relative() {
                    self.config.dcode_home.join(&rollout_path)
                } else {
                    rollout_path
                }
            }
            GetConversationSummaryParams::ThreadId { conversation_id } => {
                match dcode_core::find_thread_path_by_id_str(
                    &self.config.dcode_home,
    ...
    async fn wait_for_thread_shutdown(thread: &Arc<DcodeThread>) -> ThreadShutdownResult {
    ...
    async fn archive_thread_common(
        ...
        let rollout_folder = self.config.dcode_home.join(dcode_core::SESSIONS_SUBDIR);
    ...
    async fn skills_list(&self, request_id: ConnectionRequestId, params: SkillsListParams) {
        ...
        for cwd in cwds {
            ...
            data.push(dcode_app_server_protocol::SkillsListEntry {
                cwd,
                skills,
                errors,
            });
    ...
    async fn skills_config_write(
        ...
        let edits = vec![edit];
        let result = ConfigEditsBuilder::new(&self.config.dcode_home)
            .with_edits(edits)
            .apply()
            .await;
        ...
        match install_result {
            Ok(result) => {
                    ...
                    || !config.features.apps_enabled(Some(&self.auth_manager)).await
                {
                    ...
                    let (accessible_connectors, dcode_apps_ready) =
                        match accessible_connectors_result {
                            Ok(status) => (status.connectors, status.dcode_apps_ready),
                            Err(err) => {
                                warn!(
                                    plugin = result.plugin_id.as_key(),
                    ...
                    if !dcode_apps_ready {
                        warn!(
                            plugin = result.plugin_id.as_key(),
                            "dcode_apps MCP not ready after plugin install; skipping appsNeedingAuth check"
                        );
                    }
                ...
                let (code, message, data) = match err {
                    ...
                    SteerInputError::ActiveTurnNotSteerable { turn_kind } => {
                        let message = match turn_kind {
                            dcode_protocol::protocol::NonSteerableTurnKind::Review => {
                                "cannot steer a review turn".to_string()
                            }
                            dcode_protocol::protocol::NonSteerableTurnKind::Compact => {
                                "cannot steer a compact turn".to_string()
                            }
                        };
                        let error = TurnError {
                            message: message.clone(),
                            dcode_error_info: Some(
                                AppServerDcodeErrorInfo::ActiveTurnNotSteerable {
    ...
    async fn prepare_realtime_conversation_thread(
        ...
        request_id: ConnectionRequestId,
        thread_id: &str,
    ) -> Option<(ThreadId, Arc<DcodeThread>)> {
        let (thread_id, thread) = match self.load_thread(thread_id).await {
            Ok(v) => v,
            Err(error) => {
                self.outgoing.send_error(request_id, error).await;
    ...
    async fn start_detached_review(
        ...
        let rollout_path = if let Some(path) = parent_thread.rollout_path() {
            ...
            find_thread_path_by_id_str(&self.config.dcode_home, &parent_thread_id.to_string())
                .await
                .map_err(|err| JSONRPCErrorError {
                    code: INTERNAL_ERROR_CODE,
            ...
            loop {
                tokio::select! {
                    ...
                    event = conversation.next_event() => {
                        ...
                        // Legacy `dcode/event/*` notifications are still
                        // produced here because the in-process app-server lane
                        // (`dcode exec` and other in-process consumers) still
                        ...
                        let request_event_name = format!("dcode/event/{event_formatted}");
                        tracing::trace!(
            ...
            let setup_result = match derived_config {
                Ok(config) => {
                    let setup_request = WindowsSandboxSetupRequest {
                        ...
                        dcode_home: config.dcode_home.clone(),
                        active_profile: config.active_profile.clone(),
                    };
                    dcode_core::windows_sandbox::run_windows_sandbox_setup(setup_request).await
                }
...
async fn handle_pending_thread_resume_request(
    ...
    match find_thread_name_by_id(dcode_home, &conversation_id).await {
...
fn collect_resume_override_mismatches(
    ...
    if let Some(requested_review_policy) = request.approvals_reviewer.as_ref() {
        let active_review_policy: dcode_app_server_protocol::ApprovalsReviewer =
    ...
    if let Some(requested_sandbox) = request.sandbox.as_ref() {
        let sandbox_matches = matches!(
            ...
            (
                ...
                dcode_protocol::protocol::SandboxPolicy::DangerFullAccess
            ) | (
                SandboxMode::DangerFullAccess,
                dcode_protocol::protocol::SandboxPolicy::ExternalSandbox { .. }
            )
        );
        if !sandbox_matches {
            mismatch_details.push(format!(
...
fn skills_to_info(
    skills: &[dcode_core::skills::SkillMetadata],
    disabled_paths: &std::collections::HashSet<PathBuf>,
) -> Vec<dcode_app_server_protocol::SkillMetadata> {
    skills
        .iter()
        .map(|skill| {
            let enabled = !disabled_paths.contains(&skill.path_to_skills_md);
            dcode_app_server_protocol::SkillMetadata {
                name: skill.name.clone(),
                description: skill.description.clone(),
                short_description: skill.short_description.clone(),
                interface: skill.interface.clone().map(|interface| {
                    dcode_app_server_protocol::SkillInterface {
                        display_name: interface.display_name,
                ...
                dependencies: skill.dependencies.clone().map(|dependencies| {
                    dcode_app_server_protocol::SkillDependencies {
                        tools: dependencies
                            .tools
                            .into_iter()
                            .map(|tool| dcode_app_server_protocol::SkillToolDependency {
                                r#type: tool.r#type,
                                value: tool.value,
                                description: tool.description,
...
fn plugin_interface_to_info(
    interface: dcode_core::plugins::PluginManifestInterface,
) -> PluginInterface {
    PluginInterface {
        display_name: interface.display_name,
        short_description: interface.short_description,
...
fn errors_to_info(
    errors: &[dcode_core::skills::SkillError],
) -> Vec<dcode_app_server_protocol::SkillErrorInfo> {
    errors
        .iter()
        .map(|err| dcode_app_server_protocol::SkillErrorInfo {
            path: err.path.clone(),
...
fn validate_dynamic_tools(tools: &[ApiDynamicToolSpec]) -> Result<(), String> {
    ...
    for tool in tools {
        ...
        if let Err(err) = dcode_core::parse_tool_input_schema(&tool.input_schema) {
            return Err(format!(
...
fn replace_cloud_requirements_loader(
    ...
    let loader = cloud_requirements_loader(auth_manager, chatgpt_base_url, dcode_home);
...
async fn sync_default_client_residency_requirement(
    ...
    let loader = cloud_requirements
        ...
        .map(|guard| guard.clone())
        .unwrap_or_default();
    match dcode_core::config::ConfigBuilder::default()
...
async fn derive_config_from_params(
    ...
    dcode_core::config::ConfigBuilder::default()
...
async fn summary_from_thread_list_item(
    ...
    if let Some(thread_id) = it.thread_id {
        ...
        let source = with_thread_spawn_agent_metadata(
            it.source
                .unwrap_or(dcode_protocol::protocol::SessionSource::Unknown),
...
fn extract_conversation_summary(
    ...
    let preview = head
        ...
        .find_map(|item| match dcode_core::parse_turn_item(&item) {
...
fn preview_from_rollout_items(items: &[RolloutItem]) -> String {
    items
        ...
        .find_map(|item| match item {
            RolloutItem::ResponseItem(item) => match dcode_core::parse_turn_item(item) {
                Some(dcode_protocol::items::TurnItem::UserMessage(user)) => Some(user.message()),
                _ => None,
            },
            _ => None,
        })
...
fn with_thread_spawn_agent_metadata(
    source: dcode_protocol::protocol::SessionSource,
    agent_nickname: Option<String>,
    agent_role: Option<String>,
) -> dcode_protocol::protocol::SessionSource {
    if agent_nickname.is_none() && agent_role.is_none() {
        return source;
    }

    match source {
        dcode_protocol::protocol::SessionSource::SubAgent(
            dcode_protocol::protocol::SubAgentSource::ThreadSpawn {
                parent_thread_id,
                depth,
                agent_path,
...
mod tests {
    ...
    use anyhow::Result;
    use dcode_app_server_protocol::ServerRequestPayload;
    use dcode_app_server_protocol::ToolRequestUserInputParams;
    ...
    fn collect_resume_override_mismatches_includes_service_tier() {
        let request = ThreadResumeParams {
            ...
            model: None,
            model_provider: None,
            service_tier: Some(Some(dcode_protocol::config_types::ServiceTier::Fast)),
            cwd: None,
        ...
        let config_snapshot = ThreadConfigSnapshot {
            ...
            service_tier: Some(dcode_protocol::config_types::ServiceTier::Flex),
            approval_policy: dcode_protocol::protocol::AskForApproval::OnRequest,
            approvals_reviewer: dcode_protocol::config_types::ApprovalsReviewer::User,
            sandbox_policy: dcode_protocol::protocol::SandboxPolicy::DangerFullAccess,
    ...
    fn test_thread_metadata(
        ...
        let mut builder = ThreadMetadataBuilder::new(
            ...
            Utc::now(),
            dcode_protocol::protocol::SessionSource::default(),
        );
    ...
    fn merge_persisted_resume_metadata_prefers_persisted_model_and_reasoning_effort() -> Result<()>
    {
        ...
        let persisted_metadata =
            test_thread_metadata(Some("gpt-5.1-dcode-max"), Some(ReasoningEffort::High))?;
        ...
        assert_eq!(
            ...
            Some("gpt-5.1-dcode-max".to_string())
        );
        assert_eq!(
            request_overrides,
            Some(HashMap::from([(
    ...
    fn merge_persisted_resume_metadata_preserves_explicit_overrides() -> Result<()> {
        ...
        let mut typesafe_overrides = ConfigOverrides {
            model: Some("gpt-5.2-dcode".to_string()),
            ..Default::default()
        };
        let persisted_metadata =
            test_thread_metadata(Some("gpt-5.1-dcode-max"), Some(ReasoningEffort::High))?;
        ...
        assert_eq!(typesafe_overrides.model, Some("gpt-5.2-dcode".to_string()));
        assert_eq!(
            request_overrides,
            Some(HashMap::from([(
                "model_reasoning_effort".to_string(),
    ...
    fn merge_persisted_resume_metadata_skips_persisted_values_when_model_overridden() -> Result<()>
    {
        let mut request_overrides = Some(HashMap::from([(
            "model".to_string(),
            serde_json::Value::String("gpt-5.2-dcode".to_string()),
        )]));
        let mut typesafe_overrides = ConfigOverrides::default();
        let persisted_metadata =
            test_thread_metadata(Some("gpt-5.1-dcode-max"), Some(ReasoningEffort::High))?;
    ...
    async fn removing_thread_state_clears_listener_and_active_turn_history() -> Result<()> {
            ...
            .expect("connection should be live");
        {
            ...
            state.track_current_turn_event(&EventMsg::TurnStarted(
                dcode_protocol::protocol::TurnStartedEvent {
                    turn_id: "turn-1".to_string(),
