use crate::dcode_message_processor::ApiVersion;
use crate::dcode_message_processor::read_rollout_items_from_rollout;
use crate::dcode_message_processor::read_summary_from_rollout;
use crate::dcode_message_processor::summary_to_thread;
...
use dcode_app_server_protocol::AccountRateLimitsUpdatedNotification;
use dcode_app_server_protocol::AdditionalPermissionProfile as V2AdditionalPermissionProfile;
use dcode_app_server_protocol::AgentMessageDeltaNotification;
use dcode_app_server_protocol::ApplyPatchApprovalParams;
use dcode_app_server_protocol::ApplyPatchApprovalResponse;
use dcode_app_server_protocol::DcodeErrorInfo as V2DcodeErrorInfo;
use dcode_app_server_protocol::CollabAgentState as V2CollabAgentStatus;
use dcode_app_server_protocol::CollabAgentTool;
use dcode_app_server_protocol::CollabAgentToolCallStatus as V2CollabToolCallStatus;
use dcode_app_server_protocol::CommandAction as V2ParsedCommand;
use dcode_app_server_protocol::CommandExecutionApprovalDecision;
use dcode_app_server_protocol::CommandExecutionOutputDeltaNotification;
use dcode_app_server_protocol::CommandExecutionRequestApprovalParams;
use dcode_app_server_protocol::CommandExecutionRequestApprovalResponse;
use dcode_app_server_protocol::CommandExecutionRequestApprovalSkillMetadata;
use dcode_app_server_protocol::CommandExecutionSource;
use dcode_app_server_protocol::CommandExecutionStatus;
use dcode_app_server_protocol::ContextCompactedNotification;
use dcode_app_server_protocol::DeprecationNoticeNotification;
use dcode_app_server_protocol::DynamicToolCallOutputContentItem;
use dcode_app_server_protocol::DynamicToolCallParams;
use dcode_app_server_protocol::DynamicToolCallStatus;
use dcode_app_server_protocol::ErrorNotification;
use dcode_app_server_protocol::ExecCommandApprovalParams;
use dcode_app_server_protocol::ExecCommandApprovalResponse;
use dcode_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use dcode_app_server_protocol::FileChangeApprovalDecision;
use dcode_app_server_protocol::FileChangeOutputDeltaNotification;
use dcode_app_server_protocol::FileChangeRequestApprovalParams;
use dcode_app_server_protocol::FileChangeRequestApprovalResponse;
use dcode_app_server_protocol::FileUpdateChange;
use dcode_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use dcode_app_server_protocol::GuardianApprovalReview;
use dcode_app_server_protocol::GuardianApprovalReviewStatus;
use dcode_app_server_protocol::HookCompletedNotification;
use dcode_app_server_protocol::HookStartedNotification;
use dcode_app_server_protocol::InterruptConversationResponse;
use dcode_app_server_protocol::ItemCompletedNotification;
use dcode_app_server_protocol::ItemGuardianApprovalReviewCompletedNotification;
use dcode_app_server_protocol::ItemGuardianApprovalReviewStartedNotification;
use dcode_app_server_protocol::ItemStartedNotification;
use dcode_app_server_protocol::JSONRPCErrorError;
use dcode_app_server_protocol::McpServerElicitationAction;
use dcode_app_server_protocol::McpServerElicitationRequestParams;
use dcode_app_server_protocol::McpServerElicitationRequestResponse;
use dcode_app_server_protocol::McpServerStartupState;
use dcode_app_server_protocol::McpServerStatusUpdatedNotification;
use dcode_app_server_protocol::McpToolCallError;
use dcode_app_server_protocol::McpToolCallResult;
use dcode_app_server_protocol::McpToolCallStatus;
use dcode_app_server_protocol::ModelReroutedNotification;
use dcode_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use dcode_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use dcode_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use dcode_app_server_protocol::PatchApplyStatus;
use dcode_app_server_protocol::PermissionsRequestApprovalParams;
use dcode_app_server_protocol::PermissionsRequestApprovalResponse;
use dcode_app_server_protocol::PlanDeltaNotification;
use dcode_app_server_protocol::RawResponseItemCompletedNotification;
use dcode_app_server_protocol::ReasoningSummaryPartAddedNotification;
use dcode_app_server_protocol::ReasoningSummaryTextDeltaNotification;
use dcode_app_server_protocol::ReasoningTextDeltaNotification;
...
use dcode_app_server_protocol::SkillsChangedNotification;
use dcode_app_server_protocol::TerminalInteractionNotification;
use dcode_app_server_protocol::ThreadItem;
use dcode_app_server_protocol::ThreadNameUpdatedNotification;
use dcode_app_server_protocol::ThreadRealtimeClosedNotification;
use dcode_app_server_protocol::ThreadRealtimeErrorNotification;
use dcode_app_server_protocol::ThreadRealtimeItemAddedNotification;
use dcode_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use dcode_app_server_protocol::ThreadRealtimeStartedNotification;
use dcode_app_server_protocol::ThreadRealtimeTranscriptUpdatedNotification;
use dcode_app_server_protocol::ThreadRollbackResponse;
use dcode_app_server_protocol::ThreadTokenUsage;
use dcode_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use dcode_app_server_protocol::ToolRequestUserInputOption;
use dcode_app_server_protocol::ToolRequestUserInputParams;
use dcode_app_server_protocol::ToolRequestUserInputQuestion;
use dcode_app_server_protocol::ToolRequestUserInputResponse;
use dcode_app_server_protocol::Turn;
use dcode_app_server_protocol::TurnCompletedNotification;
use dcode_app_server_protocol::TurnDiffUpdatedNotification;
use dcode_app_server_protocol::TurnError;
use dcode_app_server_protocol::TurnInterruptResponse;
use dcode_app_server_protocol::TurnPlanStep;
use dcode_app_server_protocol::TurnPlanUpdatedNotification;
use dcode_app_server_protocol::TurnStartedNotification;
use dcode_app_server_protocol::TurnStatus;
use dcode_app_server_protocol::build_turns_from_rollout_items;
use dcode_app_server_protocol::convert_patch_changes;
use dcode_core::DcodeThread;
use dcode_core::ThreadManager;
use dcode_core::find_thread_name_by_id;
use dcode_core::review_format::format_review_findings_block;
use dcode_core::review_prompts;
use dcode_protocol::ThreadId;
use dcode_protocol::dynamic_tools::DynamicToolCallOutputContentItem as CoreDynamicToolCallOutputContentItem;
use dcode_protocol::dynamic_tools::DynamicToolResponse as CoreDynamicToolResponse;
use dcode_protocol::items::parse_hook_prompt_message;
use dcode_protocol::plan_tool::UpdatePlanArgs;
use dcode_protocol::protocol::ApplyPatchApprovalRequestEvent;
use dcode_protocol::protocol::DcodeErrorInfo as CoreDcodeErrorInfo;
...
use dcode_protocol::protocol::RealtimeEvent;
use dcode_protocol::protocol::ReviewDecision;
use dcode_protocol::protocol::ReviewOutputEvent;
use dcode_protocol::protocol::TokenCountEvent;
use dcode_protocol::protocol::TurnDiffEvent;
use dcode_protocol::request_permissions::PermissionGrantScope as CorePermissionGrantScope;
use dcode_protocol::request_permissions::RequestPermissionProfile as CoreRequestPermissionProfile;
use dcode_protocol::request_permissions::RequestPermissionsResponse as CoreRequestPermissionsResponse;
use dcode_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use dcode_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
use dcode_sandboxing::policy_transforms::intersect_permission_profiles;
use dcode_shell_command::parse_command::shlex_join;
...
fn guardian_auto_approval_review_notification(
    ...
    let review = GuardianApprovalReview {
        status: match assessment.status {
            dcode_protocol::protocol::GuardianAssessmentStatus::InProgress => {
                GuardianApprovalReviewStatus::InProgress
            }
            dcode_protocol::protocol::GuardianAssessmentStatus::Approved => {
                GuardianApprovalReviewStatus::Approved
            }
            dcode_protocol::protocol::GuardianAssessmentStatus::Denied => {
                GuardianApprovalReviewStatus::Denied
            }
            dcode_protocol::protocol::GuardianAssessmentStatus::Aborted => {
    ...
    match msg {
        ...
        EventMsg::McpStartupUpdate(update) => {
            if let ApiVersion::V2 = api_version {
                let (status, error) = match update.status {
                    dcode_protocol::protocol::McpStartupStatus::Starting => {
                        (McpServerStartupState::Starting, None)
                    }
                    dcode_protocol::protocol::McpStartupStatus::Ready => {
                        (McpServerStartupState::Ready, None)
                    }
                    dcode_protocol::protocol::McpStartupStatus::Failed { error } => {
                        (McpServerStartupState::Failed, Some(error))
                    }
                    dcode_protocol::protocol::McpStartupStatus::Cancelled => {
                    ...
                    Err(err) => {
                        ...
                        if let Err(err) = conversation
                            .submit(Op::ResolveElicitation {
                                ...
                                request_id: request.id,
                                decision: dcode_protocol::approvals::ElicitationAction::Cancel,
                                content: None,
                                meta: None,
                            })
                            .await
        ...
        EventMsg::CollabAgentSpawnEnd(end_event) => {
            ...
            let status = match &end_event.status {
                dcode_protocol::protocol::AgentStatus::Errored(_)
                | dcode_protocol::protocol::AgentStatus::NotFound => V2CollabToolCallStatus::Failed,
        ...
        EventMsg::CollabWaitingEnd(end_event) => {
            let status = if end_event.statuses.values().any(|status| {
                matches!(
                    status,
                    dcode_protocol::protocol::AgentStatus::Errored(_)
                        | dcode_protocol::protocol::AgentStatus::NotFound
                )
            }) {
        ...
        EventMsg::AgentMessageContentDelta(event) => {
            let dcode_protocol::protocol::AgentMessageContentDeltaEvent { item_id, delta, .. } =
                event;
        ...
        EventMsg::Error(ev) => {
            ...
            let dcode_error_info = ev.dcode_error_info.clone();
            ...
            if matches!(
                dcode_error_info,
                Some(CoreDcodeErrorInfo::ThreadRollbackFailed)
            ) {
            ...
            let turn_error = TurnError {
                message: ev.message,
                dcode_error_info: ev.dcode_error_info.map(V2DcodeErrorInfo::from),
...
async fn maybe_emit_raw_response_item_completed(
    ...
    conversation_id: ThreadId,
    turn_id: &str,
    item: dcode_protocol::models::ResponseItem,
    outgoing: &ThreadScopedOutgoingMessageSender,
) {
...
async fn maybe_emit_hook_prompt_item_completed(
    ...
    let dcode_protocol::models::ResponseItem::Message {
        role, content, id, ..
    } = item
    else {
        return;
    ...
    let notification = ItemCompletedNotification {
        ...
        item: ThreadItem::HookPrompt {
            ...
            fragments: hook_prompt
                .fragments
                .into_iter()
                .map(dcode_app_server_protocol::HookPromptFragment::from)
                .collect(),
        },
    };
    outgoing
...
async fn on_mcp_server_elicitation_response(
    server_name: String,
    request_id: dcode_protocol::mcp::RequestId,
    pending_request_id: RequestId,
    receiver: oneshot::Receiver<ClientRequestResult>,
    conversation: Arc<DcodeThread>,
    thread_state: Arc<Mutex<ThreadState>>,
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: dcode_app_server_protocol::PermissionGrantScope::Turn,
            }
        });
...
fn collab_resume_begin_item(
    begin_event: dcode_protocol::protocol::CollabResumeBeginEvent,
) -> ThreadItem {
...
fn collab_resume_end_item(end_event: dcode_protocol::protocol::CollabResumeEndEvent) -> ThreadItem {
    let status = match &end_event.status {
        dcode_protocol::protocol::AgentStatus::Errored(_)
        | dcode_protocol::protocol::AgentStatus::NotFound => V2CollabToolCallStatus::Failed,
        _ => V2CollabToolCallStatus::Completed,
...
mod tests {
    ...
    use dcode_app_server_protocol::GuardianApprovalReviewStatus;
    use dcode_app_server_protocol::JSONRPCErrorError;
    use dcode_app_server_protocol::TurnPlanStepStatus;
    use dcode_protocol::items::HookPromptFragment;
    use dcode_protocol::items::build_hook_prompt_message;
    use dcode_protocol::mcp::CallToolResult;
    use dcode_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
    use dcode_protocol::models::NetworkPermissions as CoreNetworkPermissions;
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                id: "item-1".to_string(),
                turn_id: String::new(),
                status: dcode_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_score: None,
                risk_level: None,
                rationale: None,
    ...
    fn guardian_assessment_completed_emits_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: dcode_protocol::protocol::GuardianAssessmentStatus::Denied,
                risk_score: Some(91),
                risk_level: Some(dcode_protocol::protocol::GuardianRiskLevel::High),
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(dcode_app_server_protocol::GuardianRiskLevel::High)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                id: "item-3".to_string(),
                turn_id: "turn-from-assessment".to_string(),
                status: dcode_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_score: None,
                risk_level: None,
                rationale: None,
                action: Some(action.clone()),
    ...
    fn collab_resume_end_maps_to_item_completed_resume_agent() {
        let event = CollabResumeEndEvent {
            ...
            receiver_agent_nickname: None,
            receiver_agent_role: None,
            status: dcode_protocol::protocol::AgentStatus::NotFound,
        };
        ...
        let expected = ThreadItem::CollabAgentToolCall {
            ...
            agents_states: [(
                receiver_id,
                V2CollabAgentStatus::from(dcode_protocol::protocol::AgentStatus::NotFound),
            )]
            .into_iter()
            .collect(),
        };
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                dcode_error_info: Some(V2DcodeErrorInfo::InternalServerError),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                dcode_error_info: Some(V2DcodeErrorInfo::Other),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_token_count_event_emits_usage_and_rate_limits() -> Result<()> {
        ...
        match second {
            OutgoingMessage::AppServerNotification(
                ...
                assert_eq!(payload.rate_limits.limit_id.as_deref(), Some("dcode"));
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                dcode_error_info: Some(V2DcodeErrorInfo::BadRequest),
                additional_details: None,
            },
            &thread_state,
        )
            ...
            OutgoingMessage::AppServerNotification(ServerNotification::ItemCompleted(
                ...
                assert_eq!(
                    ...
                    ThreadItem::HookPrompt {
                        ...
                        fragments: vec![
                            dcode_app_server_protocol::HookPromptFragment {
