...
//! detailed explanation of what "hermetic" means here lives in `dcode_client::custom_ca`; these
...
#[test]
fn prefers_dcode_ca_cert_over_ssl_cert_file() {
    let temp_dir = TempDir::new().expect("tempdir");
    let cert_path = write_cert_file(&temp_dir, "ca.pem", TEST_CERT_1);
