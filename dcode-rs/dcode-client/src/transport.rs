use crate::default_client::DcodeHttpClient;
use crate::default_client::DcodeRequestBuilder;
...
impl ReqwestTransport {
    pub fn new(client: reqwest::Client) -> Self {
        Self {
            client: DcodeHttpClient::new(client),
        }
    }

    fn build(&self, req: Request) -> Result<DcodeRequestBuilder, TransportError> {
        let Request {
            method,
            url,
            mut headers,
