...
pub enum AuthMode {
    /// OpenAI API key provided by the caller and stored by Dcode.
    ApiKey,
    /// ChatGPT OAuth managed by Dcode (tokens persisted and refreshed by Dcode).
    Chatgpt,
...
/// Superset of [`dcode_file_search::FileMatch`]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
...
server_notification_definitions! {
    ...
    /// This event is internal-only. Used by Dcode Cloud.
