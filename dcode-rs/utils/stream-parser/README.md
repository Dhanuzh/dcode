# dcode-utils-stream-parser

Small, dependency-free utilities for parsing streamed text incrementally.

**Disclaimer**: This code is pretty complex and Dcode did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust Dcode on it. Feel free to update the documentation as you
modify the code
...
```rust
use dcode_utils_stream_parser::CitationStreamParser;
use dcode_utils_stream_parser::StreamTextParser;
...
```rust
use dcode_utils_stream_parser::CitationStreamParser;
use dcode_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), dcode_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use dcode_utils_stream_parser::InlineHiddenTagParser;
use dcode_utils_stream_parser::InlineTagSpec;
use dcode_utils_stream_parser::StreamTextParser;
