...
use super::JsRuntime;
use super::dcode_app_runtime_candidates;
...
impl InstalledArtifactRuntime {
    ...
    /// machine or a Dcode desktop app bundle.
...
pub(crate) fn default_cached_runtime_root(dcode_home: &Path) -> PathBuf {
    dcode_home.join(super::DEFAULT_CACHE_ROOT_RELATIVE)
}
